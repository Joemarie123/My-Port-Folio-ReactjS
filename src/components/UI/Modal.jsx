...
const portfolio = portfolios.find(portfolio => portfolio.id === activeID);
  ...
  return (
    <div className="w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40">
         <div className="w-11/12 md:max-w-[500px] md:max-h-[800px] md:w-full  absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform -tranlate-x-1/2 -translate-y-1/2 p-5"> 
